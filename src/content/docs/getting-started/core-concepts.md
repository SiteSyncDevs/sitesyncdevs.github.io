...
- **UDT & tags** — the Ignition structure decoded data is written into. See [SiteSync tag model](/configure/udts-and-tags/tag-model/).
...
- [Product comparison](/getting-started/product-comparison/)
