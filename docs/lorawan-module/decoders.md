...
To update your decoder, paste your JavaScript decoder function into the content box and click **Save**. 

![Decoder Example](../../assets/decoder.png)
You can test your decoder using the **Testing** tab, where you can provide a payload and port number to verify the output generated by your saved decoder.

![Decoder Testing Example](../../assets/testDecoder.png)
